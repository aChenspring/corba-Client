...
public class _MLSNPPLinkIterator_IStub
	...
	implements org.tmforum.mtnm.mLSNPPLink.MLSNPPLinkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.mLSNPPLink.MLSNPPLinkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.mLSNPPLink.MLSNPPLinkList_THolder mLSNPPLink) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				mLSNPPLink.value = org.tmforum.mtnm.mLSNPPLink.MLSNPPLinkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
