...
public class _SubnetworkIterator_IStub
	...
	implements org.tmforum.mtnm.multiLayerSubnetwork.SubnetworkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.multiLayerSubnetwork.SubnetworkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.multiLayerSubnetwork.SubnetworkList_THolder subnetworkList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				subnetworkList.value = org.tmforum.mtnm.multiLayerSubnetwork.SubnetworkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
