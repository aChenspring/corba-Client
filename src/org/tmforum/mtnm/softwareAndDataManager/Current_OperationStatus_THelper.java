...
public final class Current_OperationStatus_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.softwareAndDataManager.Current_OperationStatus_THelper.id(),"Current_OperationStatus_T",new String[]{"COS_Idle","COS_Pending","COS_InProgress","COS_Completed","COS_Aborted"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.softwareAndDataManager.Current_OperationStatus_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.softwareAndDataManager.Current_OperationStatus_T extract (final org.omg.CORBA.Any any)
	{
