...
public class _BackupIdIterator_IStub
	...
	implements org.tmforum.mtnm.softwareAndDataManager.BackupIdIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.softwareAndDataManager.BackupIdIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.softwareAndDataManager.BackupIdList_THolder backupList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				backupList.value = org.tmforum.mtnm.softwareAndDataManager.BackupIdList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
