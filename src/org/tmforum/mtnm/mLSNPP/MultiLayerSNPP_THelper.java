...
public final class MultiLayerSNPP_THelper
{
	...
	public static org.tmforum.mtnm.mLSNPP.MultiLayerSNPP_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.tmforum.mtnm.mLSNPP.MultiLayerSNPP_T result = new org.tmforum.mtnm.mLSNPP.MultiLayerSNPP_T();
		...
		result.layeredSNPPList = org.tmforum.mtnm.mLSNPP.LayeredSNPPList_THelper.read(in);
		result.additionalInfo = org.tmforum.mtnm.globaldefs.NVSList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.tmforum.mtnm.mLSNPP.MultiLayerSNPP_T s)
	{
		...
		org.tmforum.mtnm.mLSNPP.LayeredSNPPList_THelper.write(out,s.layeredSNPPList);
