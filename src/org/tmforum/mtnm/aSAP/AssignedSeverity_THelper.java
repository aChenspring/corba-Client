...
public final class AssignedSeverity_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.aSAP.AssignedSeverity_THelper.id(),"AssignedSeverity_T",new String[]{"AS_INDETERMINATE","AS_CRITICAL","AS_MAJOR","AS_MINOR","AS_WARNING","AS_NONALARMED","AS_FREE_CHOICE"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.aSAP.AssignedSeverity_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.aSAP.AssignedSeverity_T extract (final org.omg.CORBA.Any any)
	{
