...
public final class EquipmentObjectTypeList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.equipment.EquipmentObjectTypeList_THelper.id(), "EquipmentObjectTypeList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.tmforum.mtnm.equipment.EquipmentObjectType_THelper.type()));
		}
		return _type;
	}
