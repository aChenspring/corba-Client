...
public final class AcknowledgeIndication_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.notifications.AcknowledgeIndication_THelper.id(),"AcknowledgeIndication_T",new String[]{"AI_EVENT_ACKNOWLEDGED","AI_EVENT_UNACKNOWLEDGED","AI_NA"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.notifications.AcknowledgeIndication_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.notifications.AcknowledgeIndication_T extract (final org.omg.CORBA.Any any)
	{
