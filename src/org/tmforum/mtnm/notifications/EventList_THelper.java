...
public final class EventList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.notifications.EventList_THelper.id(), "EventList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CosNotification.StructuredEventHelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.CosNotification.StructuredEvent[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.CosNotification.StructuredEvent[_l_result43];
