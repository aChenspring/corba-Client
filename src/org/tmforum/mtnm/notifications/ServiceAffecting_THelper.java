...
public final class ServiceAffecting_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.notifications.ServiceAffecting_THelper.id(),"ServiceAffecting_T",new String[]{"SA_UNKNOWN","SA_SERVICE_AFFECTING","SA_NON_SERVICE_AFFECTING"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.notifications.ServiceAffecting_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.notifications.ServiceAffecting_T extract (final org.omg.CORBA.Any any)
	{
