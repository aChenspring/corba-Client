...
public final class AlarmTypeQualifier_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.notifications.AlarmTypeQualifier_THelper.id(),"AlarmTypeQualifier_T",new String[]{"ALARM","TCA"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.notifications.AlarmTypeQualifier_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.notifications.AlarmTypeQualifier_T extract (final org.omg.CORBA.Any any)
	{
