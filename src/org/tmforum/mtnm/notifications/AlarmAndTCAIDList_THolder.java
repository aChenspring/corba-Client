...
{
	public org.tmforum.mtnm.notifications.AlarmOrTCAIdentifier_T[] value;

	public AlarmAndTCAIDList_THolder ()
	{
	}
	public AlarmAndTCAIDList_THolder (final org.tmforum.mtnm.notifications.AlarmOrTCAIdentifier_T[] initial)
	{
		value = initial;
	}
