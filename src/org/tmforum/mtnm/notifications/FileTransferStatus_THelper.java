...
public final class FileTransferStatus_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.notifications.FileTransferStatus_THelper.id(),"FileTransferStatus_T",new String[]{"FT_IN_PROGRESS","FT_FAILED","FT_COMPLETED"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.notifications.FileTransferStatus_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.notifications.FileTransferStatus_T extract (final org.omg.CORBA.Any any)
	{
