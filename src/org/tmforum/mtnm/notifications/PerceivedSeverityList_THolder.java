...
{
	public org.tmforum.mtnm.notifications.PerceivedSeverity_T[] value;

	public PerceivedSeverityList_THolder ()
	{
	}
	public PerceivedSeverityList_THolder (final org.tmforum.mtnm.notifications.PerceivedSeverity_T[] initial)
	{
		value = initial;
	}
