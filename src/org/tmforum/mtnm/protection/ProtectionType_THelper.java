...
public final class ProtectionType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.protection.ProtectionType_THelper.id(),"ProtectionType_T",new String[]{"PT_MSP_APS","PT_SNCP"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.protection.ProtectionType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.protection.ProtectionType_T extract (final org.omg.CORBA.Any any)
	{
