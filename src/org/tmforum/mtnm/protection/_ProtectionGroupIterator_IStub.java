...
public class _ProtectionGroupIterator_IStub
	...
	implements org.tmforum.mtnm.protection.ProtectionGroupIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.protection.ProtectionGroupIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.protection.ProtectionGroupList_THolder pgpList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				pgpList.value = org.tmforum.mtnm.protection.ProtectionGroupList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
