...
public final class ProtectionCommand_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.protection.ProtectionCommand_THelper.id(),"ProtectionCommand_T",new String[]{"PC_CLEAR","PC_LOCKOUT","PC_FORCED_SWITCH","PC_MANUAL_SWITCH","PC_EXERCISER"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.protection.ProtectionCommand_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.protection.ProtectionCommand_T extract (final org.omg.CORBA.Any any)
	{
