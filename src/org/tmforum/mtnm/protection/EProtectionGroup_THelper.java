...
public final class EProtectionGroup_THelper
{
	...
	public static org.tmforum.mtnm.protection.EProtectionGroup_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.tmforum.mtnm.protection.EProtectionGroup_T result = new org.tmforum.mtnm.protection.EProtectionGroup_T();
		...
		result.protectedList = org.tmforum.mtnm.globaldefs.NamingAttributesList_THelper.read(in);
		result.protectingList = org.tmforum.mtnm.globaldefs.NamingAttributesList_THelper.read(in);
		result.ePgpParameters = org.tmforum.mtnm.globaldefs.NVSList_THelper.read(in);
		result.additionalInfo = org.tmforum.mtnm.globaldefs.NVSList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.tmforum.mtnm.protection.EProtectionGroup_T s)
	{
		...
		org.tmforum.mtnm.globaldefs.NamingAttributesList_THelper.write(out,s.protectedList);
		org.tmforum.mtnm.globaldefs.NamingAttributesList_THelper.write(out,s.protectingList);
		org.tmforum.mtnm.globaldefs.NVSList_THelper.write(out,s.ePgpParameters);
