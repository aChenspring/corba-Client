...
public abstract class EmsSessionFactory_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.tmforum.mtnm.emsSessionFactory.EmsSessionFactory_IOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "getEmsSession", new java.lang.Integer(0));
		m_opsHash.put ( "getVersion", new java.lang.Integer(1));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.tmforum.mtnm.nmsSession.NmsSession_I _arg2=org.tmforum.mtnm.nmsSession.NmsSession_IHelper.read(_input);
				org.tmforum.mtnm.emsSession.EmsSession_IHolder _arg3= new org.tmforum.mtnm.emsSession.EmsSession_IHolder();
				_out = handler.createReply();
				getEmsSession(_arg0,_arg1,_arg2,_arg3);
				org.tmforum.mtnm.emsSession.EmsSession_IHelper.write(_out,_arg3.value);
			}
