...
public abstract class GuiCutThroughMgr_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.tmforum.mtnm.guiCutThrough.GuiCutThroughMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "destroyGCT", new java.lang.Integer(2));
		m_opsHash.put ( "getGCTProfileInfo", new java.lang.Integer(3));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(4));
		m_opsHash.put ( "setAdditionalInfo", new java.lang.Integer(5));
		m_opsHash.put ( "launchGCT", new java.lang.Integer(6));
		m_opsHash.put ( "setOwner", new java.lang.Integer(7));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // getGCTProfileInfo
			{
			try
			{
				org.tmforum.mtnm.guiCutThrough.GCTProfileInfo_THolder _arg0= new org.tmforum.mtnm.guiCutThrough.GCTProfileInfo_THolder();
				_out = handler.createReply();
				getGCTProfileInfo(_arg0);
				org.tmforum.mtnm.guiCutThrough.GCTProfileInfo_THelper.write(_out,_arg0.value);
			}
			catch(org.tmforum.mtnm.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
			...
			try
			{
				...
				org.tmforum.mtnm.globaldefs.NVSList_THolder _arg6= new org.tmforum.mtnm.globaldefs.NVSList_THolder();
				_out = handler.createReply();
				launchGCT(_arg0,_arg1,_arg2,_arg3,_arg4,_arg5,_arg6);
				_out.write_boolean(_arg5.value);
				org.tmforum.mtnm.globaldefs.NVSList_THelper.write(_out,_arg6.value);
			}
			catch(org.tmforum.mtnm.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
