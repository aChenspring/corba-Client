...
public final class ServerLaunchCapability_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.guiCutThrough.ServerLaunchCapability_THelper.id(),"ServerLaunchCapability_T",new String[]{"CLIENT_LAUNCH_ONLY","SERVER_LAUNCH_CAPABLE"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.guiCutThrough.ServerLaunchCapability_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.guiCutThrough.ServerLaunchCapability_T extract (final org.omg.CORBA.Any any)
	{
