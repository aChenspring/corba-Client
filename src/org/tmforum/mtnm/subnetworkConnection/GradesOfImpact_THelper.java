...
public final class GradesOfImpact_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.subnetworkConnection.GradesOfImpact_THelper.id(),"GradesOfImpact_T",new String[]{"GOI_HITLESS","GOI_MINOR_IMPACT","GOI_MAJOR_IMPACT"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.subnetworkConnection.GradesOfImpact_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.subnetworkConnection.GradesOfImpact_T extract (final org.omg.CORBA.Any any)
	{
