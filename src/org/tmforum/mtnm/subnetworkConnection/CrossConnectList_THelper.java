...
public final class CrossConnectList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.subnetworkConnection.CrossConnectList_THelper.id(), "CrossConnectList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.tmforum.mtnm.subnetworkConnection.CrossConnect_THelper.type()));
		}
		return _type;
	}
	...
	public static org.tmforum.mtnm.subnetworkConnection.CrossConnect_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.tmforum.mtnm.subnetworkConnection.CrossConnect_T[_l_result70];
