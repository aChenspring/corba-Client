...
public final class ResourceList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.subnetworkConnection.ResourceList_THelper.id(), "ResourceList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.tmforum.mtnm.subnetworkConnection.Resource_THelper.type()));
		}
		return _type;
	}
	...
	public static org.tmforum.mtnm.globaldefs.NameAndStringValue_T[][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.tmforum.mtnm.globaldefs.NameAndStringValue_T[_l_result71][];
