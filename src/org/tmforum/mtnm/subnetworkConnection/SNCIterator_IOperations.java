...
public interface SNCIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, org.tmforum.mtnm.subnetworkConnection.SubnetworkConnectionList_THolder sncList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException;
