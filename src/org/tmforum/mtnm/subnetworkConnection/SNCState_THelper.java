...
public final class SNCState_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.subnetworkConnection.SNCState_THelper.id(),"SNCState_T",new String[]{"SNCS_NONEXISTENT","SNCS_PENDING","SNCS_ACTIVE","SNCS_PARTIAL"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.subnetworkConnection.SNCState_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.subnetworkConnection.SNCState_T extract (final org.omg.CORBA.Any any)
	{
