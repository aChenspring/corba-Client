...
public class _TopologicalLinkIterator_IStub
	...
	implements org.tmforum.mtnm.topologicalLink.TopologicalLinkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.topologicalLink.TopologicalLinkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.topologicalLink.TopologicalLinkList_THolder topoLinkList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				topoLinkList.value = org.tmforum.mtnm.topologicalLink.TopologicalLinkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
