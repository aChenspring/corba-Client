...
public final class MaintenanceOperationMode_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.maintenanceOps.MaintenanceOperationMode_THelper.id(),"MaintenanceOperationMode_T",new String[]{"MOM_OPERATE","MOM_RELEASE"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.maintenanceOps.MaintenanceOperationMode_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.maintenanceOps.MaintenanceOperationMode_T extract (final org.omg.CORBA.Any any)
	{
