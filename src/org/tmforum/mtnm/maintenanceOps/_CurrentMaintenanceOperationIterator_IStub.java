...
public class _CurrentMaintenanceOperationIterator_IStub
	...
	implements org.tmforum.mtnm.maintenanceOps.CurrentMaintenanceOperationIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.maintenanceOps.CurrentMaintenanceOperationIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.maintenanceOps.CurrentMaintenanceOperationList_THolder cMOList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				cMOList.value = org.tmforum.mtnm.maintenanceOps.CurrentMaintenanceOperationList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
