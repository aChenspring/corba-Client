...
public final class CommunicationState_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.managedElement.CommunicationState_THelper.id(),"CommunicationState_T",new String[]{"CS_AVAILABLE","CS_UNAVAILABLE"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.managedElement.CommunicationState_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.managedElement.CommunicationState_T extract (final org.omg.CORBA.Any any)
	{
