...
public final class ServiceCategory_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.trafficDescriptor.ServiceCategory_THelper.id(),"ServiceCategory_T",new String[]{"SC_CBR","SC_VBRRT","SC_VBRNRT","SC_ABR","SC_UBR","SC_GFR","SC_NA"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.trafficDescriptor.ServiceCategory_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.trafficDescriptor.ServiceCategory_T extract (final org.omg.CORBA.Any any)
	{
