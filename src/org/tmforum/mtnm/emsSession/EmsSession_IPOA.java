...
public abstract class EmsSession_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.tmforum.mtnm.emsSession.EmsSession_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getManager", new java.lang.Integer(2));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			org.tmforum.mtnm.session.Session_IHelper.write(_out,associatedSession());
				break;
			}
			case 1: // ping
			{
			...
			try
			{
				...
				org.tmforum.mtnm.common.Common_IHolder _arg1= new org.tmforum.mtnm.common.Common_IHolder();
				_out = handler.createReply();
				getManager(_arg0,_arg1);
				org.tmforum.mtnm.common.Common_IHelper.write(_out,_arg1.value);
			}
			...
			try
			{
				org.tmforum.mtnm.emsSession.EmsSession_IPackage.managerNames_THolder _arg0= new org.tmforum.mtnm.emsSession.EmsSession_IPackage.managerNames_THolder();
				_out = handler.createReply();
				getSupportedManagers(_arg0);
				org.tmforum.mtnm.emsSession.EmsSession_IPackage.managerNames_THelper.write(_out,_arg0.value);
			}
			catch(org.tmforum.mtnm.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
