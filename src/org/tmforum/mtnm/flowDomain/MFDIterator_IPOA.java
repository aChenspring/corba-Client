...
public abstract class MFDIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.tmforum.mtnm.flowDomain.MFDIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.tmforum.mtnm.flowDomain.MFDList_THolder _arg1= new org.tmforum.mtnm.flowDomain.MFDList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				org.tmforum.mtnm.flowDomain.MFDList_THelper.write(_out,_arg1.value);
			}
			catch(org.tmforum.mtnm.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
