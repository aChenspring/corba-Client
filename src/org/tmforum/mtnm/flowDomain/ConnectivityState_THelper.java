...
public final class ConnectivityState_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.flowDomain.ConnectivityState_THelper.id(),"ConnectivityState_T",new String[]{"CS_UNKNOWN","CS_FULLY_CONNECTED","CS_NOT_FULLY_CONNECTED"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.flowDomain.ConnectivityState_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.flowDomain.ConnectivityState_T extract (final org.omg.CORBA.Any any)
	{
