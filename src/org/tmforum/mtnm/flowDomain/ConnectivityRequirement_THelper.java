...
public final class ConnectivityRequirement_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.flowDomain.ConnectivityRequirement_THelper.id(),"ConnectivityRequirement_T",new String[]{"CR_IGNORE","CR_REJECT"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.flowDomain.ConnectivityRequirement_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.flowDomain.ConnectivityRequirement_T extract (final org.omg.CORBA.Any any)
	{
