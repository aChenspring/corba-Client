...
public class _FDIterator_IStub
	...
	implements org.tmforum.mtnm.flowDomain.FDIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.flowDomain.FDIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.flowDomain.FDList_THolder fdList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				fdList.value = org.tmforum.mtnm.flowDomain.FDList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
