...
public class _MFDIterator_IStub
	...
	implements org.tmforum.mtnm.flowDomain.MFDIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.flowDomain.MFDIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.flowDomain.MFDList_THolder mfdList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				mfdList.value = org.tmforum.mtnm.flowDomain.MFDList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
