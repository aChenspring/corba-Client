...
public final class CPTP_Role_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.flowDomain.CPTP_Role_THelper.id(),"CPTP_Role_T",new String[]{"CPTPR_FD_EDGE","CPTPR_FD_INTERNAL","CPTPR_ALL"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.flowDomain.CPTP_Role_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.flowDomain.CPTP_Role_T extract (final org.omg.CORBA.Any any)
	{
