...
public final class TPProtectionAssociation_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.terminationPoint.TPProtectionAssociation_THelper.id(),"TPProtectionAssociation_T",new String[]{"TPPA_NA","TPPA_PSR_RELATED"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.terminationPoint.TPProtectionAssociation_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.terminationPoint.TPProtectionAssociation_T extract (final org.omg.CORBA.Any any)
	{
