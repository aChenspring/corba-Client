...
public final class TPType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.terminationPoint.TPType_THelper.id(),"TPType_T",new String[]{"TPT_PTP","TPT_CTP","TPT_TPPool"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.terminationPoint.TPType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.terminationPoint.TPType_T extract (final org.omg.CORBA.Any any)
	{
