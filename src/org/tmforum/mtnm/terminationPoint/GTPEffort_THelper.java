...
public final class GTPEffort_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.terminationPoint.GTPEffort_THelper.id(),"GTPEffort_T",new String[]{"EFFORT_WHATEVER","EFFORT_SAME"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.terminationPoint.GTPEffort_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.terminationPoint.GTPEffort_T extract (final org.omg.CORBA.Any any)
	{
