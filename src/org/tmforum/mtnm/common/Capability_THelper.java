...
public final class Capability_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.common.Capability_THelper.id(), "Capability_T",org.tmforum.mtnm.globaldefs.NameAndStringValue_THelper.type());
		}
		return _type;
	}
	...
	public static org.tmforum.mtnm.globaldefs.NameAndStringValue_T read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result=org.tmforum.mtnm.globaldefs.NameAndStringValue_THelper.read(_in);
		return _result;
	}
	...
	{
		org.tmforum.mtnm.globaldefs.NameAndStringValue_THelper.write(_out,_s);
	}
}
