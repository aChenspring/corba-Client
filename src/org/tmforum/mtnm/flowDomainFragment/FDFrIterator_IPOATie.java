	...
	extends FDFrIterator_IPOA
{
	...
	public org.tmforum.mtnm.flowDomainFragment.FDFrIterator_I _this()
	{
		return org.tmforum.mtnm.flowDomainFragment.FDFrIterator_IHelper.narrow(_this_object());
	}
	public org.tmforum.mtnm.flowDomainFragment.FDFrIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.tmforum.mtnm.flowDomainFragment.FDFrIterator_IHelper.narrow(_this_object(orb));
	}
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.flowDomainFragment.FDFrList_THolder fdfrList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
