...
public class _MFDFrIterator_IStub
	...
	implements org.tmforum.mtnm.flowDomainFragment.MFDFrIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.tmforum.mtnm.flowDomainFragment.MFDFrIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.flowDomainFragment.MatrixFlowDomainFragmentList_THolder mfdfrList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				mfdfrList.value = org.tmforum.mtnm.flowDomainFragment.MatrixFlowDomainFragmentList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
