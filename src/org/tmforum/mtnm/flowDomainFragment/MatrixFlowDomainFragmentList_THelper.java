...
public final class MatrixFlowDomainFragmentList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.flowDomainFragment.MatrixFlowDomainFragmentList_THelper.id(), "MatrixFlowDomainFragmentList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.tmforum.mtnm.flowDomainFragment.MatrixFlowDomainFragment_THelper.type()));
		}
		return _type;
	}
	...
	public static org.tmforum.mtnm.flowDomainFragment.MatrixFlowDomainFragment_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.tmforum.mtnm.flowDomainFragment.MatrixFlowDomainFragment_T[_l_result17];
