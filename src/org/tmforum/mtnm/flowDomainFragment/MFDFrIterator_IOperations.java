...
public interface MFDFrIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, org.tmforum.mtnm.flowDomainFragment.MatrixFlowDomainFragmentList_THolder mfdfrList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException;
