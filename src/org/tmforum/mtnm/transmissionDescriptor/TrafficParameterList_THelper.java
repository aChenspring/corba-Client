...
public final class TrafficParameterList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.transmissionDescriptor.TrafficParameterList_THelper.id(), "TrafficParameterList_T",org.tmforum.mtnm.globaldefs.NVSList_THelper.type());
		}
		return _type;
	}
