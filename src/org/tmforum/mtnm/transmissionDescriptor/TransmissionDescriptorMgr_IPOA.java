...
public abstract class TransmissionDescriptorMgr_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptorMgr_IOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setTMDAssociation", new java.lang.Integer(0));
		...
		m_opsHash.put ( "deleteTransmissionDescriptor", new java.lang.Integer(4));
		m_opsHash.put ( "validateTMDAssignmentToObject", new java.lang.Integer(5));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(6));
		m_opsHash.put ( "getTransmissionDescriptor", new java.lang.Integer(7));
		m_opsHash.put ( "setOwner", new java.lang.Integer(8));
		m_opsHash.put ( "getAssociatedTPs", new java.lang.Integer(9));
		m_opsHash.put ( "createTransmissionDescriptor", new java.lang.Integer(10));
		m_opsHash.put ( "modifyTransmissionDescriptor", new java.lang.Integer(11));
		m_opsHash.put ( "getAllTransmissionDescriptors", new java.lang.Integer(12));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		{
			case 0: // setTMDAssociation
			{
			try
			{
				org.tmforum.mtnm.globaldefs.NameAndStringValue_T[] _arg0=org.tmforum.mtnm.globaldefs.NVSList_THelper.read(_input);
				org.tmforum.mtnm.transmissionDescriptor.TPorMFDorFDFr_THolder _arg1= new org.tmforum.mtnm.transmissionDescriptor.TPorMFDorFDFr_THolder();
				_arg1._read (_input);
				_out = handler.createReply();
				setTMDAssociation(_arg0,_arg1);
				org.tmforum.mtnm.transmissionDescriptor.TPorMFDorFDFr_THelper.write(_out,_arg1.value);
			}
			...
			case 4: // deleteTransmissionDescriptor
			{
			try
			{
				org.tmforum.mtnm.globaldefs.NameAndStringValue_T[] _arg0=org.tmforum.mtnm.globaldefs.NVSList_THelper.read(_input);
			...
			case 5: // validateTMDAssignmentToObject
			{
			try
			{
				org.tmforum.mtnm.globaldefs.NameAndStringValue_T[] _arg0=org.tmforum.mtnm.globaldefs.NVSList_THelper.read(_input);
			...
			{
				org.tmforum.mtnm.globaldefs.NameAndStringValue_T[] _arg0=org.tmforum.mtnm.globaldefs.NVSList_THelper.read(_input);
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THolder _arg1= new org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THolder();
				_out = handler.createReply();
				getTransmissionDescriptor(_arg0,_arg1);
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THelper.write(_out,_arg1.value);
			}
			catch(org.tmforum.mtnm.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 10: // createTransmissionDescriptor
			{
			try
			{
				org.tmforum.mtnm.transmissionDescriptor.TMDCreateData_T _arg0=org.tmforum.mtnm.transmissionDescriptor.TMDCreateData_THelper.read(_input);
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THolder _arg1= new org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THolder();
				_out = handler.createReply();
			...
			case 11: // modifyTransmissionDescriptor
			{
			try
			{
				org.tmforum.mtnm.globaldefs.NameAndStringValue_T[] _arg0=org.tmforum.mtnm.globaldefs.NVSList_THelper.read(_input);
				org.tmforum.mtnm.transmissionDescriptor.TMDModifyData_T _arg1=org.tmforum.mtnm.transmissionDescriptor.TMDModifyData_THelper.read(_input);
				...
				_arg2._read (_input);
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THolder _arg3= new org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THolder();
				_arg3._read (_input);
				...
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptor_THelper.write(_out,_arg3.value);
			...
			case 12: // getAllTransmissionDescriptors
			{
			try
			{
				int _arg0=_input.read_ulong();
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptorList_THolder _arg1= new org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptorList_THolder();
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptorIterator_IHolder _arg2= new org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptorIterator_IHolder();
				_out = handler.createReply();
				getAllTransmissionDescriptors(_arg0,_arg1,_arg2);
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptorList_THelper.write(_out,_arg1.value);
				org.tmforum.mtnm.transmissionDescriptor.TransmissionDescriptorIterator_IHelper.write(_out,_arg2.value);
			}
			catch(org.tmforum.mtnm.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
