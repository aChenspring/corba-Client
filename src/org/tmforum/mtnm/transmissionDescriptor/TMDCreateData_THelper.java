...
public final class TMDCreateData_THelper
{
	...
	public static org.tmforum.mtnm.transmissionDescriptor.TMDCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.tmforum.mtnm.transmissionDescriptor.TMDCreateData_T result = new org.tmforum.mtnm.transmissionDescriptor.TMDCreateData_T();
		result.userLabel=in.read_string();
		result.forceUniqueness=in.read_boolean();
		result.owner=in.read_string();
		result.transmissionParams = org.tmforum.mtnm.transmissionParameters.LayeredParameterList_THelper.read(in);
		result.additionalObjectInfo = org.tmforum.mtnm.globaldefs.NVSList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.tmforum.mtnm.transmissionDescriptor.TMDCreateData_T s)
	{
		out.write_string(s.userLabel);
		out.write_boolean(s.forceUniqueness);
		out.write_string(s.owner);
		org.tmforum.mtnm.transmissionParameters.LayeredParameterList_THelper.write(out,s.transmissionParams);
		org.tmforum.mtnm.globaldefs.NVSList_THelper.write(out,s.additionalObjectInfo);
