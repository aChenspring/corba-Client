...
public final class TPorMFDorFDFrQualifier_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.tmforum.mtnm.transmissionDescriptor.TPorMFDorFDFrQualifier_THelper.id(),"TPorMFDorFDFrQualifier_T",new String[]{"aTP","aMFD","aFDFr"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.tmforum.mtnm.transmissionDescriptor.TPorMFDorFDFrQualifier_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.tmforum.mtnm.transmissionDescriptor.TPorMFDorFDFrQualifier_T extract (final org.omg.CORBA.Any any)
	{
