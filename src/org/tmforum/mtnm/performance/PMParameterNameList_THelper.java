...
public final class PMParameterNameList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.performance.PMParameterNameList_THelper.id(), "PMParameterNameList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.tmforum.mtnm.performance.PMParameterName_THelper.type()));
		}
		return _type;
	}
