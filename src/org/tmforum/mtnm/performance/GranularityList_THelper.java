...
public final class GranularityList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.performance.GranularityList_THelper.id(), "GranularityList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.tmforum.mtnm.performance.Granularity_THelper.type()));
		}
		return _type;
	}
