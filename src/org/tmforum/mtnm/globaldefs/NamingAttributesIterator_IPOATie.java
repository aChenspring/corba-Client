	...
	extends NamingAttributesIterator_IPOA
{
	...
	public org.tmforum.mtnm.globaldefs.NamingAttributesIterator_I _this()
	{
		return org.tmforum.mtnm.globaldefs.NamingAttributesIterator_IHelper.narrow(_this_object());
	}
	public org.tmforum.mtnm.globaldefs.NamingAttributesIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.tmforum.mtnm.globaldefs.NamingAttributesIterator_IHelper.narrow(_this_object(orb));
	}
	...
	public boolean next_n(int how_many, org.tmforum.mtnm.globaldefs.NamingAttributesList_THolder nameList) throws org.tmforum.mtnm.globaldefs.ProcessingFailureException
	{
