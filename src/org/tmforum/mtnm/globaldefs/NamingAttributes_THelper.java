...
public final class NamingAttributes_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.globaldefs.NamingAttributes_THelper.id(), "NamingAttributes_T",org.tmforum.mtnm.globaldefs.NVSList_THelper.type());
		}
		return _type;
	}
