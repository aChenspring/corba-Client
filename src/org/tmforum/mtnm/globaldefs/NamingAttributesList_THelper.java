...
public final class NamingAttributesList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.tmforum.mtnm.globaldefs.NamingAttributesList_THelper.id(), "NamingAttributesList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.tmforum.mtnm.globaldefs.NamingAttributes_THelper.type()));
		}
		return _type;
	}
	...
	public static org.tmforum.mtnm.globaldefs.NameAndStringValue_T[][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.tmforum.mtnm.globaldefs.NameAndStringValue_T[_l_result21][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = org.tmforum.mtnm.globaldefs.NVSList_THelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, org.tmforum.mtnm.globaldefs.NameAndStringValue_T[][] _s)
	{
		...
		{
			org.tmforum.mtnm.globaldefs.NVSList_THelper.write(_out,_s[i]);
		}
