...
public class EventLogPOATie
	extends EventLogPOA
{
	private EventLogOperations _delegate;

	private POA _poa;
	public EventLogPOATie(EventLogOperations delegate)
	{
		_delegate = delegate;
	}
	public EventLogPOATie(EventLogOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public EventLogOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EventLogOperations delegate)
	{
		_delegate = delegate;
	}
