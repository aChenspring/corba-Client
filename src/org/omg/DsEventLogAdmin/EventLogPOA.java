...
public abstract class EventLogPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.DsEventLogAdmin.EventLogOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "for_suppliers", new java.lang.Integer(6));
		m_opsHash.put ( "get_forwarding_state", new java.lang.Integer(7));
		m_opsHash.put ( "get_interval", new java.lang.Integer(8));
		m_opsHash.put ( "set_log_full_action", new java.lang.Integer(9));
		m_opsHash.put ( "set_administrative_state", new java.lang.Integer(10));
		m_opsHash.put ( "my_factory", new java.lang.Integer(11));
		m_opsHash.put ( "get_record_attribute", new java.lang.Integer(12));
		m_opsHash.put ( "get_current_size", new java.lang.Integer(13));
		m_opsHash.put ( "query", new java.lang.Integer(14));
		m_opsHash.put ( "set_max_size", new java.lang.Integer(15));
		m_opsHash.put ( "set_log_qos", new java.lang.Integer(16));
		m_opsHash.put ( "for_consumers", new java.lang.Integer(17));
		m_opsHash.put ( "set_week_mask", new java.lang.Integer(18));
		m_opsHash.put ( "destroy", new java.lang.Integer(19));
		m_opsHash.put ( "set_max_record_life", new java.lang.Integer(20));
		m_opsHash.put ( "retrieve", new java.lang.Integer(21));
		m_opsHash.put ( "set_record_attribute", new java.lang.Integer(22));
		m_opsHash.put ( "set_interval", new java.lang.Integer(23));
		m_opsHash.put ( "flush", new java.lang.Integer(24));
		m_opsHash.put ( "set_forwarding_state", new java.lang.Integer(25));
		m_opsHash.put ( "get_capacity_alarm_thresholds", new java.lang.Integer(26));
		m_opsHash.put ( "delete_records", new java.lang.Integer(27));
		m_opsHash.put ( "copy", new java.lang.Integer(28));
		m_opsHash.put ( "get_availability_status", new java.lang.Integer(29));
		m_opsHash.put ( "get_max_record_life", new java.lang.Integer(30));
		m_opsHash.put ( "get_week_mask", new java.lang.Integer(31));
		m_opsHash.put ( "get_log_qos", new java.lang.Integer(32));
		m_opsHash.put ( "write_records", new java.lang.Integer(33));
		m_opsHash.put ( "copy_with_id", new java.lang.Integer(34));
		m_opsHash.put ( "get_operational_state", new java.lang.Integer(35));
		m_opsHash.put ( "set_capacity_alarm_thresholds", new java.lang.Integer(36));
		m_opsHash.put ( "get_log_full_action", new java.lang.Integer(37));
		m_opsHash.put ( "get_n_records", new java.lang.Integer(38));
	}
	private String[] ids = {"IDL:omg.org/DsEventLogAdmin/EventLog:1.0","IDL:omg.org/DsLogAdmin/Log:1.0","IDL:omg.org/CosEventChannelAdmin/EventChannel:1.0"};
	public org.omg.DsEventLogAdmin.EventLog _this()
	{
		return org.omg.DsEventLogAdmin.EventLogHelper.narrow(_this_object());
	}
	public org.omg.DsEventLogAdmin.EventLog _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.DsEventLogAdmin.EventLogHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 10: // set_administrative_state
			{
			...
			case 37: // get_log_full_action
			{
				_out = handler.createReply();
				_out.write_ushort(get_log_full_action());
				break;
			}
			case 38: // get_n_records
			{
				_out = handler.createReply();
