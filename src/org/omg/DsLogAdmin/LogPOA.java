...
public abstract class LogPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.DsLogAdmin.LogOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "set_max_record_life", new java.lang.Integer(17));
		m_opsHash.put ( "retrieve", new java.lang.Integer(18));
		m_opsHash.put ( "set_record_attribute", new java.lang.Integer(19));
		m_opsHash.put ( "set_interval", new java.lang.Integer(20));
		m_opsHash.put ( "flush", new java.lang.Integer(21));
		m_opsHash.put ( "set_forwarding_state", new java.lang.Integer(22));
		m_opsHash.put ( "get_capacity_alarm_thresholds", new java.lang.Integer(23));
		m_opsHash.put ( "delete_records", new java.lang.Integer(24));
		m_opsHash.put ( "copy", new java.lang.Integer(25));
		m_opsHash.put ( "get_availability_status", new java.lang.Integer(26));
		m_opsHash.put ( "get_max_record_life", new java.lang.Integer(27));
		m_opsHash.put ( "get_week_mask", new java.lang.Integer(28));
		m_opsHash.put ( "get_log_qos", new java.lang.Integer(29));
		m_opsHash.put ( "write_records", new java.lang.Integer(30));
		m_opsHash.put ( "copy_with_id", new java.lang.Integer(31));
		m_opsHash.put ( "get_operational_state", new java.lang.Integer(32));
		m_opsHash.put ( "set_capacity_alarm_thresholds", new java.lang.Integer(33));
		m_opsHash.put ( "get_n_records", new java.lang.Integer(34));
		m_opsHash.put ( "get_log_full_action", new java.lang.Integer(35));
	}
	private String[] ids = {"IDL:omg.org/DsLogAdmin/Log:1.0"};
	public org.omg.DsLogAdmin.Log _this()
	{
		return org.omg.DsLogAdmin.LogHelper.narrow(_this_object());
	}
	public org.omg.DsLogAdmin.Log _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.DsLogAdmin.LogHelper.narrow(_this_object(orb));
	}
