...
public final class TimeTHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.DsLogAdmin.TimeTHelper.id(), "TimeT",org.omg.TimeBase.TimeTHelper.type());
		}
		return _type;
	}
	...
	{
		return "IDL:omg.org/DsLogAdmin/TimeT:1.0";
	}
