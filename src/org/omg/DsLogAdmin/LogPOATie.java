...
public class LogPOATie
	extends LogPOA
{
	private LogOperations _delegate;

	private POA _poa;
	public LogPOATie(LogOperations delegate)
	{
		_delegate = delegate;
	}
	public LogPOATie(LogOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public void _delegate(LogOperations delegate)
	{
		_delegate = delegate;
	}
