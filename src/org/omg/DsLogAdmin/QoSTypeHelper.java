...
/**
 *	Generated from IDL definition of alias "QoSType"
 *	@author JacORB IDL compiler 
 */

public final class QoSTypeHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.DsLogAdmin.QoSTypeHelper.id(), "QoSType",org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(4)));
		}
		return _type;
	}
	...
	{
		return "IDL:omg.org/DsLogAdmin/QoSType:1.0";
	}
