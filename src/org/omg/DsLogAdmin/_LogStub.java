...
public class _LogStub
	...
	implements org.omg.DsLogAdmin.Log
{
	...
	public final static java.lang.Class _opsClass = org.omg.DsLogAdmin.LogOperations.class;
	public long get_max_size()
	{
		...
		else
		{
			...
			LogOperations _localServant = (LogOperations)_so.servant;
			long _result;			try
			{
